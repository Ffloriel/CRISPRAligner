        ...
        if first:
            ...
            for d in range(1, len(cassette)):
                ...
                for e in range(len(consensus)):
                    ...
                    if consensus_match[0] >= (len(consensus[e]) - 2) or consensus_match[
                        1
                    ] >= (len(consensus[e]) - 2):
...
def write_aligned_files(
    ...
    with csv_path.open("w") as csv_file, align_path.open(
        "w"
    ) as align_file, unique_path.open("w") as unique_file, binary_path.open(
        "w"
    ) as binary_file:
        ...
        for i in range(len(sample_list)):
            ...
            for k in range(1, len(consensus)):
                ...
                for j in range(1, len(sample_list[i])):
                    ...
                    if (
                        consensus_match[0] >= len(consensus[k]) - 2
                        or consensus_match[1] >= len(consensus[k]) - 2
                    ):
                        ...
                        if (
                            len(sample_list[i][j]) != len(consensus[k])
                            and consensus_match[0] < consensus_match[1]
                        ):
                            align_file.write(
                                "-" * (len(consensus[k]) - len(sample_list[i][j]))
                            )
